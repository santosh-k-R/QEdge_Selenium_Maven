...
public class DataDriven {
	...
	WebDriver driver;
	String inputpath="F:\\QEdgeWorksace\\Maven_ERP\\TestInput\\InputSheet.xlsx";
	String outputpath="F:\\QEdgeWorksace\\Maven_ERP\\TestOutput\\Hybrid.xlsx";
	@BeforeTest
	...
	public void supplierCreation()throws Throwable
	{
		...
		Reporter.log("Nor of rows are"+rc,true);
		for(int i=1;i<=rc;i++)
		{
