...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser() throws Throwable
	{
		...
		{
			System.setProperty("webdriver.chrome.driver","F:\\QEdgeWorksace\\Maven_ERP\\CommonDrivers\\chromedriver.exe");
			driver=new ChromeDriver();
		}
		else if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox"))
		{
			System.setProperty("webdriver.gecko.driver", "F:\\QEdgeWorksace\\Maven_ERP\\CommonDrivers\\geckodriver.exe");
	...
	public static void captureData(WebDriver driver,String locatortype,String locatorvalue) throws Throwable
	{
		...
		FileWriter fw=new FileWriter("F:\\QEdgeWorksace\\Maven_ERP\\CaptureData\\supplier.txt");
	...
	{
		FileReader fr= new FileReader("F:\\QEdgeWorksace\\Maven_ERP\\CaptureData\\supplier.txt");
